...
if a="1" then
	...
	public i4
	i4=inputbox("1.Java中在控制台输出的简写是：a.syso b.sosy c.printf")
	public i5
	i5=inputbox("2.java中的类的英文名是：a.lei b.class c.Class")
	public i6
	i6=inputbox("3.java中定义长字符(非个字符)应是用关键字:a.string b.char c.int")
